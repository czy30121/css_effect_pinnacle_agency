...
(0, _gsapDefault.default).to(".respprojects", {
    opacity: 1,
    duration: 1,
    scrollTrigger: {
        trigger: ".respimg2",
...
// 	}
// );
(0, _gsapDefault.default).to(".second_img", {
    scale: 1.4,
    opacity: 1,
    duration: 1,
    scrollTrigger: {
...
(0, _gsapDefault.default).fromTo(".second_img", {
    y: 0,
    opacity: 1
}, {
    y: -150,
...
(0, _gsapDefault.default).fromTo(".respimg4", {
    opacity: 0
}, {
    scale: 1.6,
    opacity: 1,
...
// 	}
// );
(0, _gsapDefault.default).fromTo(".respimg6", {
    opacity: 0
}, {
    scaleY: 2.15,
    scaleX: 2.12,
...
(0, _gsapDefault.default).to(".respimg4", {
    opacity: 1,
    duration: 1,
    scrollTrigger: {
        trigger: ".second_img",
...
(0, _gsapDefault.default).fromTo(".per_img", {
    opacity: 1
}, {
    // width: "100%",
    margin: "0 -55px",
...
(0, _gsapDefault.default).fromTo(".rcompostimgs", {
    opacity: 1
}, {
    opacity: 0,
    ease: "power2.out",
...
(0, _gsapDefault.default).fromTo(".final", {
    opacity: 0
}, {
    opacity: 1,
    scrollTrigger: {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hF8lp","igcvL"], "igcvL", "parcelRequirefd8f")
